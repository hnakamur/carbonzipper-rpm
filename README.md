...
A Dockerfile to build [go-graphite/carbonzipper: proxy to transparently merge graphite carbon backends](https://github.com/go-graphite/carbonzipper) rpm for CentOS 7 using [fedora copr](https://copr.fedoraproject.org/).
